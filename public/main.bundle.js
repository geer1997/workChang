...
var AdministratorDashboardComponent = /** @class */ (function () {
    ...
    AdministratorDashboardComponent.prototype.modificarUser = function () {
        var _this = this;
        var bool = this.firstName && this.firstName.length < 45 &&
            this.lastName && this.lastName.length < 45 &&
            this.username && this.username.length < 20 &&
            this.email && this.email.length < 255 &&
            this.addressLine1 && this.addressLine1.length < 45 &&
    ...
    AdministratorDashboardComponent.prototype.claveBusqueda = function (buscaPor) {
        switch (buscaPor) {
    ...
    AdministratorDashboardComponent.prototype.repuestoSelec = function (replacement) {
...
var ClientDashboardComponent = /** @class */ (function () {
    ...
    */
    ...
    ClientDashboardComponent.prototype.historicoVehiculo = function (licensePlate) {
        var _this = this;
    ...
    ClientDashboardComponent.prototype.alternarDiv = function (estado) {
        this.divDescargas = estado;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('descargar'),
        __metadata("design:type", Object)
    ], ClientDashboardComponent.prototype, "btn", void 0);
        ...
        if (!credentials.username) {
            ...
            this.auth.login(credentials).subscribe(function (data) {
                if (data.success) {
                    ...
                    _this.flash.show('¡Bienvenido de nuevo! ' + _this.username.toUpperCase(), { cssClass: 'custom-alert-success', timeout: 3000 });
    ...
    ManagerDashboardComponent.prototype.cerrarOrden = function (ordenID) {
        ...
        this.api.cerrarOrden(datos).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flash.show('Orden cerrada satisfactoriamente', { cssClass: 'custom-alert-success', timeout: 3000 });
            }
            else {
                _this.flash.show(data.msg, { cssClass: 'custom-alert-danger', timeout: 3000 });
            }
